...
const AVISOS_PRUEBA: Record<string, { tono: string; texto: string }> = {
  ...
  error: {
    tono: "critico",
    texto: "No se pudo enviar. Revisa el método de envío y las credenciales.",
  },
  sincreds: {
    tono: "aviso",
    texto: "Faltan credenciales para el método elegido. Guárdalas antes de probar.",
  },
  ...
  oautherror: {
    tono: "critico",
    texto: "No se pudo conectar con Microsoft. Revisa los datos de Azure e inténtalo de nuevo.",
  },
  oauthfalta: {
    tono: "aviso",
    texto: "Primero guarda el Tenant, Client ID y secreto de Azure; luego conecta.",
  },
};
...
export default async function ConfigCorreo({
  ...
  const pista =
    (prueba === "error" || prueba === "oautherror") && detalle ? pistaError(detalle) : null;
    ...
    <div className="correo-wrap">
      ...
      <form className="config-prueba destacada" action={enviarPruebaCorreo}>
        ...
        <div className="config-prueba-fila">
          ...
          />
          <BotonEnviar className="boton" ocupado="Enviando…">
            Enviar prueba
          </BotonEnviar>
        </div>
      ...
      <section className="config-seccion metodo-bloque bloque-oauth seccion-oauth">
        ...
        {conectado ? (
          <>
            ...
            <div className="oauth-acciones">
              <form action={conectarMicrosoft}>
                <BotonEnviar className="boton secundario" ocupado="Conectando…">
                  Reconectar
                </BotonEnviar>
              </form>
          ...
          <>
            ...
            <form action={conectarMicrosoft}>
              <BotonEnviar className="boton" ocupado="Conectando…">
